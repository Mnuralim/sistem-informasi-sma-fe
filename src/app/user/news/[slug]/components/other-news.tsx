    ...
    <div>
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-5">
          <button className="bg-dark-blue p-0.5 rounded-sm">
      ...
      <div className="flex flex-col gap-y-6">
        {otherNews.map((news) => (
          <Link href={`/user/news/${news.slug}`} key={news.id} className="grid grid-cols-3 gap-5">
            <div className="col-span-1">
              <Image
                ...
                width={500}
                height={500}
                className="object-cover object-center w-full aspect-square rounded-sm shadow overflow-hidden"
              />
            </div>
            <div className="col-span-2 flex flex-col justify-between">
              ...
              <h1 className="line-clamp-2 text-dark-blue font-bold underline">{extractFirstSentence(news.content)}</h1>
              <div className="flex items-center gap-2">
