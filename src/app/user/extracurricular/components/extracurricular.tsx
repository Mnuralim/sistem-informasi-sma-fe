...
const Extracurricular: React.FC<ExtracurricularProps> = ({ name, description, photo }) => {
  return (
    <div className="bg-white shadow-lg p-6 rounded-lg mb-6 flex flex-col items-center">
      <Image width={500} height={500} src={photo} alt={name} className="w-full h-48 rounded-lg mb-4 object-cover" />
